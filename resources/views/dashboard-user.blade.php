                        ...
                        @forelse(App\Models\Material::latest()->take(5)->get() as $material)
                            <li class="py-4" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 50 }}">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <a href="{{ route('materials.showuser', $material->id) }}"
                                            class="inline-flex items-center shadow-sm px-3 py-1 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                                            Lihat
                                        </a>
                                    </div>
                                </div>
